...
img = cv2.imread('E:/PMN_Estimation/data_Preparation/14-12-2021/croped_images/1.jpg', 1)
totDistance = (len(img)+len(img[0]))*0.02645833
print('height of the nodule',len(img))
print('width of the nodule',len(img[0]))
#print('height of the nodule in meter',len(img)*0.02645833)
#print('width of the nodule in meter',len(img[0])*0.02645833)
#print('Tot distance in centi-meter', totDistance)
print('dimension -- ', img.shape)
print('size -- ', img.size)
print('height of the nodule in millimeter',len(img)*0.26458333)
number_of_black_pix = np.sum(img == 0)
#print('number_of_black_pix -- ',number_of_black_pix*0.26458333)
...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    #model =  torch.hub.load('C:/Users/lenovo/Desktop/distance estimation/yolov5-master', 'custom', source ='local', path='best.pt',force_reload=True) ### The repo is stored locally
...
# Define the codec and create VideoWriter object.The output is stored in 'outpy.avi' file. 
            out = cv2.VideoWriter('D:/hindustan final project/test_image/outpy.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 24, (width,height)) 
...
main(vid_path="doc.mp4",vid_out="result.avi") ### for custom video
