...
length_label2 = Label(Frame_Horizaontal_left_child_UR_child_bottom, text="Focal Length", bg = "white").\
    grid(row=2, column=0, pady=4, padx = 4)
...
Label_NodulesCount = Label(Frame_Horizaontal_left_child_BL,text = "No of Nodules detected" , bg = "white")
